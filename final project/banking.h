...
// Fraud thresholds (tuned to not instantly freeze)
#define FRAUD_WITHDRAW_LIMIT   10      // withdrawals allowed per window
#define FRAUD_WINDOW_SECS      60      // rolling window in seconds
#define FRAUD_UNFREEZE_SECS    120     // auto-unfreeze after 2 minutes
...
struct Account {
    ...
    bool            frozen;
    bool            active;
    time_t          frozen_at;       // timestamp when frozen (for auto-unfreeze)
...
extern long                logged_in_acc;   // 0 = manager
